...
public final class CadastroCursos_jsp extends org.apache.jasper.runtime.HttpJspBase
...
out.print(usuario);
      ...
      out.write("                        <img src=\"/Projeto_DCE/IMAGES/nossos-cursos.jpg\" class=\"img-responsive\">\n");
      out.write("                    </div>\n");
      out.write("                </div>\n");
      out.write("            </div>\n");
      out.write("        </div>\n");
 ...
 if (menssagem!= null) {out.print(menssagem);}
      out.write("</a>\n");
      out.write("                        <form role=\"form\" action=\"ControllerCurso.jsp\" method=\"post\">\n");
      out.write("                            <div class=\"form-group\">\n");
      out.write("                                    <label for=\"buscaID_Curso\" class=\"control-label\"></label>\n");
      out.write("                                    <input type=\"number\" class=\"form-control\" name=\"buscaID_Curso\" placeholder=\"Digite a ID do curso\">\n");
      out.write("                            </div>\n");
      out.write("                            <div class=\"form-group\">\n");
      ...
      out.write("                                <input class=\"form-control\" name=\"nome\" placeholder=\"Nome do curso de graduaÃ§Ã£o\" type=\"text\" ");
 if (retorno != null) {
      out.write("value=\"");
out.print((String)session.getAttribute("campo1"));
      out.write('"');
}
      out.write(">\n");
      out.write("                            </div>\n");
      out.write("                            <div class=\"form-group\">\n");
      out.write("                                <label class=\"control-label\" for=\"horario\">HorÃ¡rio</label>\n");
      out.write("                                <input class=\"form-control\" name=\"horario\" type=\"text\" placeholder=\"Ex: Noturno\" ");
 if (retorno != null) {
      out.write("value=\"");
out.print((String)session.getAttribute("campo2"));
      out.write('"');
}
      out.write(">\n");
      out.write("                            </div>\n");
      out.write("                            <div class=\"form-group\">\n");
      out.write("                                <label class=\"control-label\" for=\"cargaHoraria\">Carga HorÃ¡ria</label>\n");
      out.write("                                <input class=\"form-control\" name=\"cargaHoraria\" type=\"text\" placeholder=\"EX(horas): 220\" ");
 if (retorno != null) {
      out.write("value=\"");
out.print((String)session.getAttribute("campo3"));
      ...
      out.write("                                <input class=\"form-control\" name=\"descricao\" type=\"text\" placeholder=\"Objetivo do curso\" ");
 if (retorno != null) {
      out.write("value=\"");
out.print((String)session.getAttribute("campo4"));
      ...
      out.write("                                            <button type=\"submit\" class=\"btn btn-primary\" name=\"BotaoComando\" value=\"salvar\">Salvar</button>\n");
      out.write("                                        </div>\n");
      out.write("                                        ");
 if (usuario != null && usuario.equals("admin")) {
      out.write("\n");
