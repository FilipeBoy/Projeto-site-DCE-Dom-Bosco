                    ...
                    <div class="col-md-12">
                        ...
                        <form role="form" action="ControllerNoticia.jsp" method="post">
                            <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="busca" placeholder="Digite a ID da Notícia">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="Autor" placeholder="Nome do autor" type="text" <% if (retorno != null) {%>value="<%out.print((String)session.getAttribute("campo1"));%>"<%}%>>
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="Data">Data</label>
                                <input class="form-control" name="Data" type="text" placeholder="Data de publicação" <% if (retorno != null) {%>value="<%out.print((String)session.getAttribute("campo2"));%>"<%}%>>
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="Titulo">Título</label>
                                <input class="form-control" name="Titulo" type="text" placeholder="Título da notícia" <% if (retorno != null) {%>value="<%out.print((String)session.getAttribute("campo3"));%>"<%}%>>
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="Texto">Texto</label>
                                <input class="form-control" name="Texto" type="text" placeholder="Digite o texto" <% if (retorno != null) {%>value="<%out.print((String)session.getAttribute("campo4"));%>"<%}%>>
                            </div>
                            <div class="section">
                                <div class="container">
                                    <div class="row">
