...
<html><head>
        ...
        <div class="section">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <a class="btn btn-primary" href="Login.jsp">Ler mais</a>
                        
                    </div>
                    
                    <div class="col-md-6">
                        <a class="btn btn-primary" href="Login.jsp">Ler mais</a>
                        <a class="btn btn-primary" href="AlugueArmario.jsp">Formulário</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="section">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <a class="btn btn-primary" href="Login.jsp">Ler mais</a>
                        <a class="btn btn-primary" href="Sugestoes.jsp">Formulário</a>
                    </div>
                    <div class="col-md-6">
                        <a class="btn btn-primary" href="Login.jsp">Ler mais</a>
                         <a class="btn btn-primary" href="Perdidos.jsp">Formulário</a>
                    </div>
                </div>
            </div>
        </div>
