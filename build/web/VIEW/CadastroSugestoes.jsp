<%
    ...
    String usuario=(String)session.getAttribute("Nome");
      ...
      String status=(String)session.getAttribute("campo3");
%>
<html><head>
                    ...
                    <div class="col-md-9">
                        ...
                        <form role="form" action="ControllerSugestao.jsp" method="post">
                            <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="busca" placeholder="Digite a ID da sugestão">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" class="form-control" >
                                    <% if (retorno != null) {%>
                                    <option selected value="<%=status%>"><%out.print(status);%></option>
