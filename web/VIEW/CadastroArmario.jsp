                    ...
                    <div class="col-md-9">
                        ...
                        <form role="form" action="ControllerArmario.jsp" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="NroRegistro" type="number" placeholder="Nao é necessario preencher" <% if(retorno != null) {%> value=<%out.print(Integer.parseInt(session.getAttribute("campo1").toString()));%><%}%>>
                            </div>
                            <div class="form-group">
